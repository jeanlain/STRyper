...
/// The fluorescence data generated by the sequencer are stored in the chromatogram ``traces``.
///
...
///   - folder: The folder that will contain the chromatogram.
...
/// Applies a size standard to the sample.
///
/// This method sets the ``sizeStandard`` attribute to `sizeStandard`, then calls ``Trace/findLadderFragmentsAndComputeSizing``.
/// - Parameter sizeStandard: The size standard to apply to the sample.
