...
- (NSPredicate *)searchPredicate {
	NSPredicate *searchPredicate = [NSKeyedUnarchiver unarchivedObjectOfClass: NSPredicate.class fromData:self.searchPredicateData error:nil];
	[searchPredicate allowEvaluation];
